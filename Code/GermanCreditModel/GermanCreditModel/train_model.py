...
DATA_PATH = 'C:/Users/Lenovo/Downloads/german_credit_data (1).csv'
try:
...
CATEGORICAL_FEATURE_COLUMNS_USED_FILENAME = 'categorical_features_used.pkl' # Lưu tên các cột phân loại đã dùng
NUMERIC_FEATURE_COLUMNS_USED_FILENAME = 'numeric_features_used.pkl' # Lưu tên các cột số đã dùng
FILLNA_VALUE_FILENAME = 'fillna_value.pkl' # Lưu giá trị fillna (nếu cố định)
